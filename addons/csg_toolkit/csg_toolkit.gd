...
var mesh_converter_button: CSGMeshConverterButton
...
func _enter_tree():
	...
	var mesh_converter_button_scene = preload("res://addons/csg_toolkit/scenes/csg_mesher_button.tscn")
	mesh_converter_button = mesh_converter_button_scene.instantiate()
	...
	add_control_to_container(EditorPlugin.CONTAINER_SPATIAL_EDITOR_MENU, mesh_converter_button)
...
func _exit_tree():
	...
	remove_control_from_container(EditorPlugin.CONTAINER_SPATIAL_EDITOR_MENU, mesh_converter_button)
	dock.free()
